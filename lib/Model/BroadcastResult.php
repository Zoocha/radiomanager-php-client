 ...
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class BroadcastResult implements ModelInterface, ArrayAccess
{
    ...
    const REPETITION_TYPE__2_WEEK = '2 week';
    const REPETITION_TYPE__4_WEEK = '4 week';
    ...
    public function getRepetitionTypeAllowableValues()
    {
        return [
            ...
            self::REPETITION_TYPE__2_WEEK,
            self::REPETITION_TYPE__4_WEEK,
    ...
    public function listInvalidProperties()
    {
        ...
        if (!in_array($this->container['repetition_type'], $allowedValues)) {
     ...
     * Sets repetition_uid
     *
     * @param string $repetition_uid repetition_uid
     *
     * @return $this
     */
     ...
     *
     * @param string $repetition_type repetition_type
     *
     * @return $this
     */
    ...
    {
        $allowedValues = $this->getRepetitionTypeAllowableValues();
        if (!is_null($repetition_type) && !in_array($repetition_type, $allowedValues)) {
     ...
     * Sets repetition_end
     *
     * @param \DateTime $repetition_end repetition_end
     *
     * @return $this
     */
     ...
     *
     * @param \DateTime $repetition_start repetition_start
     *
     * @return $this
     */
     ...
     *
     * @param string $repetition_days repetition_days
     *
     * @return $this
     */
     ...
     * Sets presenters
     *
     * @param \RadioManager\Model\BroadcastRelationsPresenters $presenters presenters
     *
     * @return $this
     */
