...
class StationApi
{
    ...
    {
        $returnType = '\RadioManager\Model\StationResult';
        $request = $this->getStationRequest();
     ...
     */
    public function getStationAsync()
    {
        return $this->getStationAsyncWithHttpInfo()
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getStationAsyncWithHttpInfo()
    {
        $returnType = '\RadioManager\Model\StationResult';
        $request = $this->getStationRequest();
     ...
     */
    protected function getStationRequest()
    {
