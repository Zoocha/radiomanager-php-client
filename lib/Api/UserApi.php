...
class UserApi
{
    ...
    {
        return $this->deleteUserByIdAsyncWithHttpInfo($id)->then(function ($response) {
            return $response[0];
        });
    }
    ...
    public function getUserByIdWithHttpInfo($id)
    {
        ...
        try {
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize($e->getResponseBody(), '\RadioManager\Model\UserResult', $e->getResponseHeaders());
                    $e->setResponseObject($data);
                    break;
                case 403:
                    $data = ObjectSerializer::deserialize($e->getResponseBody(), '\RadioManager\Model\Forbidden', $e->getResponseHeaders());
    ...
    {
        return $this->getUserByIdAsyncWithHttpInfo($id)->then(function ($response) {
            return $response[0];
        });
    }
    ...
    public function inviteUserByMailWithHttpInfo($data)
    {
        ...
        try {
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize($e->getResponseBody(), '\RadioManager\Model\InviteUserSuccess', $e->getResponseHeaders());
                    $e->setResponseObject($data);
                    break;
                case 403:
                    $data = ObjectSerializer::deserialize($e->getResponseBody(), '\RadioManager\Model\Forbidden', $e->getResponseHeaders());
    ...
    {
        return $this->inviteUserByMailAsyncWithHttpInfo($data)->then(function ($response) {
            return $response[0];
        });
    }
    ...
    public function listUsersWithHttpInfo($page = '1', $role_id = null)
    {
        ...
        $request = $this->listUsersRequest($page, $role_id);
        ...
        try {
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize($e->getResponseBody(), '\RadioManager\Model\UserResults', $e->getResponseHeaders());
                    $e->setResponseObject($data);
                    break;
                case 403:
                    $data = ObjectSerializer::deserialize($e->getResponseBody(), '\RadioManager\Model\Forbidden', $e->getResponseHeaders());
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function listUsersAsync($page = '1', $role_id = null)
    {
        return $this->listUsersAsyncWithHttpInfo($page, $role_id)->then(function ($response) {
            return $response[0];
        });
    }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function listUsersAsyncWithHttpInfo($page = '1', $role_id = null)
    {
        $returnType = '\RadioManager\Model\UserResults';
        $request = $this->listUsersRequest($page, $role_id);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function listUsersRequest($page = '1', $role_id = null)
    {
        if ($page !== null && $page < 0) {
