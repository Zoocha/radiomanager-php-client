...
class StoryApi
{
    ...
    {
        return $this->createStoryAsyncWithHttpInfo($data)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    protected function createStoryRequest($data)
    {
        ...
        if ($data === null) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $data when calling createStory'
            );
        }
    ...
    {
        return $this->deleteStoryByIdAsyncWithHttpInfo($id)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    protected function deleteStoryByIdRequest($id)
    {
        ...
        if ($id === null) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $id when calling deleteStoryById'
            );
        }
        if ($id < 0) {
    ...
    {
        return $this->getStoryByIdAsyncWithHttpInfo($id, $_external_station_id)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    public function listStoriesWithHttpInfo($page = '1', $item_id = null, $model_type_id = null, $tag_id = null, $limit = null, $order_by = null, $order_direction = null, $_external_station_id = null)
    {
        ...
        $request = $this->listStoriesRequest($page, $item_id, $model_type_id, $tag_id, $limit, $order_by, $order_direction, $_external_station_id);
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function listStoriesAsync($page = '1', $item_id = null, $model_type_id = null, $tag_id = null, $limit = null, $order_by = null, $order_direction = null, $_external_station_id = null)
    {
        return $this->listStoriesAsyncWithHttpInfo($page, $item_id, $model_type_id, $tag_id, $limit, $order_by, $order_direction, $_external_station_id)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function listStoriesAsyncWithHttpInfo($page = '1', $item_id = null, $model_type_id = null, $tag_id = null, $limit = null, $order_by = null, $order_direction = null, $_external_station_id = null)
    {
        $returnType = '\RadioManager\Model\StoryResults';
        $request = $this->listStoriesRequest($page, $item_id, $model_type_id, $tag_id, $limit, $order_by, $order_direction, $_external_station_id);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function listStoriesRequest($page = '1', $item_id = null, $model_type_id = null, $tag_id = null, $limit = null, $order_by = null, $order_direction = null, $_external_station_id = null)
    {
        if ($page !== null && $page < 0) {
    ...
    {
        return $this->updateStoryByIDAsyncWithHttpInfo($id, $data)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    protected function updateStoryByIDRequest($id, $data = null)
    {
        ...
        if ($id === null) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $id when calling updateStoryByID'
            );
        }
        if ($id < 0) {
