...
class StringApi
{
    ...
    public function getStringsByNameWithHttpInfo($name, $full_model)
    {
        ...
        try {
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize($e->getResponseBody(), '\RadioManager\Model\TextString', $e->getResponseHeaders());
    ...
    {
        return $this->getStringsByNameAsyncWithHttpInfo($name, $full_model)->then(function ($response) {
            return $response[0];
        });
    }
