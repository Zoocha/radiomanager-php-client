...
class StringApi
{
    ...
    public function getStringsByNameWithHttpInfo($name, $full_model)
    {
        ...
        try {
            ...
            return [$this->apiClient->getSerializer()->deserialize($response, '\RadioManager\Model\TextString', $httpHeader), $statusCode, $httpHeader];
        } catch (ApiException $e) {
            switch ($e->getCode()) {
                case 200:
                    $data = $this->apiClient->getSerializer()->deserialize($e->getResponseBody(), '\RadioManager\Model\TextString', $e->getResponseHeaders());
