...
class TagApi
{
    ...
    {
        return $this->createTagAsyncWithHttpInfo($data)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    protected function createTagRequest($data)
    {
        ...
        if ($data === null) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $data when calling createTag'
            );
        }
    ...
    {
        return $this->getTagByIdAsyncWithHttpInfo($id, $_external_station_id)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    public function listTagsWithHttpInfo($page = null, $program_id = null, $item_id = null, $broadcast_id = null, $contact_id = null, $limit = null, $order_by = null, $order_direction = null, $_external_station_id = null)
    {
        ...
        $request = $this->listTagsRequest($page, $program_id, $item_id, $broadcast_id, $contact_id, $limit, $order_by, $order_direction, $_external_station_id);
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function listTagsAsync($page = null, $program_id = null, $item_id = null, $broadcast_id = null, $contact_id = null, $limit = null, $order_by = null, $order_direction = null, $_external_station_id = null)
    {
        return $this->listTagsAsyncWithHttpInfo($page, $program_id, $item_id, $broadcast_id, $contact_id, $limit, $order_by, $order_direction, $_external_station_id)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function listTagsAsyncWithHttpInfo($page = null, $program_id = null, $item_id = null, $broadcast_id = null, $contact_id = null, $limit = null, $order_by = null, $order_direction = null, $_external_station_id = null)
    {
        $returnType = '\RadioManager\Model\TagResults';
        $request = $this->listTagsRequest($page, $program_id, $item_id, $broadcast_id, $contact_id, $limit, $order_by, $order_direction, $_external_station_id);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function listTagsRequest($page = null, $program_id = null, $item_id = null, $broadcast_id = null, $contact_id = null, $limit = null, $order_by = null, $order_direction = null, $_external_station_id = null)
    {
        if ($page !== null && $page < 1) {
    ...
    {
        return $this->updateTagByIDAsyncWithHttpInfo($id, $data)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    protected function updateTagByIDRequest($id, $data = null)
    {
        ...
        if ($id === null) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $id when calling updateTagByID'
            );
        }
        if ($id < 0) {
