...
class GenreApi
{
     ...
     * @return \RadioManager\RadioManagerModels\GenreResult
     */
    public function getGenreById($id, $_station_id = null)
    {
        list($response) = $this->getGenreByIdWithHttpInfo($id, $_station_id);
        return $response;
    }
     ...
     * @param int $_station_id Query on a different (content providing) station *(Optional)* (optional)
     * @throws \RadioManager\ApiException on non-2xx response
     * @return array of \RadioManager\RadioManagerModels\GenreResult, HTTP status code, HTTP response headers (array of strings)
     */
    public function getGenreByIdWithHttpInfo($id, $_station_id = null)
    {
        ...
        try {
            list($response, $statusCode, $httpHeader) = $this->apiClient->callApi(
                ...
                $httpBody,
                $headerParams,
                '\RadioManager\RadioManagerModels\GenreResult',
                '/genres/{id}'
            );

            return [$this->apiClient->getSerializer()->deserialize($response, '\RadioManager\RadioManagerModels\GenreResult', $httpHeader), $statusCode, $httpHeader];
        } catch (ApiException $e) {
            switch ($e->getCode()) {
                case 200:
                    $data = $this->apiClient->getSerializer()->deserialize($e->getResponseBody(), '\RadioManager\RadioManagerModels\GenreResult', $e->getResponseHeaders());
     ...
     * @param int $_station_id Query on a different (content providing) station *(Optional)* (optional)
     * @throws \RadioManager\ApiException on non-2xx response
     * @return \RadioManager\RadioManagerModels\GenreResults
     */
    public function listGenres($page = null, $parent_id = null, $program_id = null, $broadcast_id = null, $_station_id = null)
    {
        list($response) = $this->listGenresWithHttpInfo($page, $parent_id, $program_id, $broadcast_id, $_station_id);
        return $response;
    }
     ...
     * @param int $_station_id Query on a different (content providing) station *(Optional)* (optional)
     * @throws \RadioManager\ApiException on non-2xx response
     * @return array of \RadioManager\RadioManagerModels\GenreResults, HTTP status code, HTTP response headers (array of strings)
     */
    public function listGenresWithHttpInfo($page = null, $parent_id = null, $program_id = null, $broadcast_id = null, $_station_id = null)
    {
        ...
        try {
            list($response, $statusCode, $httpHeader) = $this->apiClient->callApi(
                ...
                $httpBody,
                $headerParams,
                '\RadioManager\RadioManagerModels\GenreResults',
                '/genres'
            );

            return [$this->apiClient->getSerializer()->deserialize($response, '\RadioManager\RadioManagerModels\GenreResults', $httpHeader), $statusCode, $httpHeader];
        } catch (ApiException $e) {
            switch ($e->getCode()) {
                case 200:
                    $data = $this->apiClient->getSerializer()->deserialize($e->getResponseBody(), '\RadioManager\RadioManagerModels\GenreResults', $e->getResponseHeaders());
                    $e->setResponseObject($data);
                    break;
                case 404:
                    $data = $this->apiClient->getSerializer()->deserialize($e->getResponseBody(), '\RadioManager\RadioManagerModels\NotFound', $e->getResponseHeaders());
